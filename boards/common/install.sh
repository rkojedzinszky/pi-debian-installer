...
install_kernel()
{
	...
	echo "deb http://apt.srv.kojedz.in/ stretch main" > $rootdir/etc/apt/sources.list.d/apt.srv.kojedz.in.list
	chroot $rootdir apt-get update
	chroot $rootdir apt-get -f -y install linux-image-krichy
}
